(() => {
  ...
  const modules = {
    ...
    master_data_export: [['master_data_preparation', 'LinksMasterDataPreparation']],
    ...
    office_work: [['annual_closings', 'LinksAnnualClosings'], ['office_work', 'LinksOfficeWork']],
    daily_reports: [['time-input', 'LinksTimeInput'], ['daily-entry-ui', 'LinksDailyEntryUI'], ['pdf_imports', 'LinksPdfImports'], ['additional_items', 'LinksAdditionalItems'], ['daily_report_imports', 'LinksDailyReportImports'], ['daily_reports', 'LinksDailyReports']],
    ...
    analytics: [['annual_closings', 'LinksAnnualClosings'], ['analytics', 'LinksAnalytics']],
    master_settings: [['bank_export_master', 'LinksBankExportMaster'], ['additional_items', 'LinksAdditionalItems'], ['master_settings', 'LinksMasterSettings']],
