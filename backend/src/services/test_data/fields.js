...
const IMPORT_FIELDS = {
  ...
  partners: [field('code','パートナー番号',['パートナーコード','code','no','コード','番号']), field('name','氏名',['名前','名称','パートナー名']),
    field('nameKana','氏名カナ',['フリガナ','氏名フリガナ']), field('phone','電話番号',['電話','TEL']), field('address','住所'), field('searchText','検索用')],
