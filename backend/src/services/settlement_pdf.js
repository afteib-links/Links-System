...
function commonCss() {
  return `@page{size:A4;margin:9mm 14mm}*{box-sizing:border-box}html,body{margin:0;padding:0;color:#111;font-family:"Yu Mincho","Hiragino Mincho ProN","Noto Serif JP",serif;font-size:9.3pt}body{background:#fff}.sheet{position:relative;width:100%;min-height:277mm;page-break-after:always}.sheet:last-child{page-break-after:auto}h1{margin:0;text-align:center;font-size:18pt;letter-spacing:.12em;white-space:nowrap}h2{text-align:center;font-size:16pt;letter-spacing:.28em;margin:11mm 0 5mm}.top-grid{display:grid;grid-template-columns:52% 48%;gap:7mm;align-items:start}.recipient-box{border:1px solid #111;min-height:31mm;padding:5mm 6mm;font-size:10.5pt}.recipient-name{font-size:13pt;font-weight:700;margin-top:6mm;border-bottom:2px solid #111;display:inline-block;padding:0 3mm 1mm}.recipient-name.small{font-size:11pt;margin-top:2mm}.issuer{position:relative;margin:3mm auto 0;width:92%;font-size:8.7pt;line-height:1.35}.issuer.compact{margin-top:2mm}.issuer-name{font-weight:700;font-size:10pt}.logo{width:43mm;height:10mm;background:#5b9bd5;color:#fff;display:flex;align-items:center;justify-content:center;font:bold 10pt sans-serif;margin:0 auto 1mm}.logo img{max-width:100%;max-height:100%}.stamp-image{position:absolute;right:4mm;top:10mm;max-width:23mm;max-height:23mm}.rule-title{height:1.2mm;border-top:2px solid #111;border-bottom:1px solid #111;margin:1mm auto 2mm;width:75%}.issue-date{text-align:center;background:#e2f0d9;padding:1mm;margin:0 auto;width:75%}.invoice-meta{display:grid;grid-template-columns:60% 40%;gap:6mm;align-items:end;margin-top:6mm}.amount-box{display:grid;grid-template-columns:2fr 1fr;border:1px solid #111;width:55%;margin-top:4mm}.amount-box>div{display:flex;flex-direction:column;text-align:center;padding:2mm;border-right:1px solid #111}.amount-box>div:last-child{border-right:0}.amount-box strong{font-size:13pt}.amount-box span{font-size:19pt;font-weight:700;margin-top:2mm}.amount-box>div:last-child span{font-size:11pt;font-weight:400}.invoice-bank{position:absolute;right:0;top:78mm;width:39%}.bank{font-size:8.5pt;line-height:1.35;margin-top:2mm}.note{margin-top:2mm}.lines{border-collapse:collapse;width:100%;margin-top:6mm;table-layout:fixed}.lines th,.lines td{border:1px solid #111;padding:1.15mm 1.6mm;height:6.3mm}.lines thead th{background:#050505;color:#fff;font-weight:400;letter-spacing:.16em}.lines .no{width:8mm}.lines th:nth-child(3),.lines th:nth-child(4){width:18mm}.lines th:nth-child(5){width:28mm}.lines .blank td{height:6.3mm}.money,.num{text-align:right;white-space:nowrap}.center{text-align:center}.negative{color:#d90000}.sum th{font-weight:400}.document-number{position:absolute;bottom:2mm;right:0;font-size:7pt;color:#666}.payment-top{grid-template-columns:48% 52%}.pay-date{background:#ddebf7;border-bottom:2px solid #111;padding:1mm;text-align:center;margin:2mm auto 0;width:70%}.payment-total{display:flex;gap:10mm;align-items:baseline;border-bottom:2px solid #111;width:48%;margin-top:5mm;font-size:16pt}.payment-total strong{font-size:21pt}.compact-lines{margin-top:3mm;font-size:8.5pt}.compact-lines th,.compact-lines td{height:5.2mm;padding:.7mm 1mm}.split-rule{border-top:3px solid #111;margin-top:10mm}.work-invoice-head{display:grid;grid-template-columns:58% 42%;gap:4mm}.claim-total{display:flex;align-items:baseline;gap:5mm;border-bottom:2px solid #111;width:60%;font-size:13pt;margin:4mm 0}.claim-total strong{font-size:22pt}.work-lines{margin-top:3mm;font-size:8.2pt}.work-lines th,.work-lines td{height:4.8mm;padding:.55mm 1mm}.work-lines .sum th{font-size:7pt;letter-spacing:0;white-space:nowrap}.emphasis{background:#fff2cc;font-weight:700}.salary-head{display:grid;grid-template-columns:58% 42%;align-items:start;margin:11mm 12mm 5mm}.salary-head h1{text-align:left;font-size:16pt}.salary-table,.salary-summary{border-collapse:collapse;width:100%}.salary-table th,.salary-table td,.salary-summary th,.salary-summary td{border:1px solid #111;padding:2mm}.salary-table th,.salary-summary th{background:#d9e2f3}.salary-horizontal{margin:3mm 12mm;width:calc(100% - 24mm);table-layout:fixed;text-align:center}.salary-horizontal .salary-side{width:11mm}.salary-horizontal th:not(.salary-side){font-size:8pt}.salary-summary{margin:7mm 12mm;width:calc(100% - 24mm);text-align:center}.cover-subject{display:grid;grid-template-columns:18mm 1fr;border-bottom:2px solid #111;margin-top:48mm}.cover-subject strong{background:#333;color:#fff;text-align:center;padding:3mm}.cover-subject span{padding:3mm}.cover-body{font-size:11pt;line-height:2.25;margin-top:7mm}.right{text-align:right}.cover-end{margin-top:18mm}.enclosures{margin:8mm auto;width:80%}.enclosures>div{display:grid;grid-template-columns:12mm 1fr 20mm;border-bottom:1px solid #111;padding:3mm}.cover-sheet h2{font-size:12pt;letter-spacing:.2em}@media print{.sheet{overflow:hidden}}`;
}
...
function renderHtml(document, lines = []) {
  ...
  return `<!doctype html><html lang="ja"><head><meta charset="utf-8"><style>${commonCss()}</style></head><body>${body}</body></html>`;
}
