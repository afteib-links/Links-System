...
async function applyDailyPriceCalcWithRules(data, dependencies = {}) {
  ...
  return applyDailyPriceCalcWithRuleSet(data,selected,{ dailyCalculator });
}

async function applyDailyPriceCalcWithRuleSet(data, selected, dependencies = {}) {
  const dailyCalculator = dependencies.dailyCalculator || applyDailyPriceCalc;
...
module.exports = { applyDailyPriceCalcWithRules,applyDailyPriceCalcWithRuleSet,parseDetail };
