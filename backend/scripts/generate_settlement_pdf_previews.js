...
async function main() {
  await writePdf({ ...base, settlement_type:'invoice', document_type:'invoice', document_number:'PREVIEW-INVOICE', subtotal_amount:60900, tax_amount:6090, total_amount:66990 }, lines.slice(0, 3));
  await writePdf({ ...base, settlement_type:'invoice', document_type:'invoice_summary', document_number:'PREVIEW-INVOICE-SUMMARY', subtotal_amount:60900, tax_amount:6090, total_amount:66990 }, lines.slice(0, 3));
  await writePdf({ ...base, settlement_type:'payment', document_type:'payment_statement', document_number:'PREVIEW-PAYMENT', gross_amount:60900, total_amount:39000 }, lines);
